...
I started by scraping Ink's public documentation using [Puppeteer](https://pptr.dev) and [Cheerio](https://cheerio.js.org). I wrote a script using [PDFMerger](https://www.npmjs.com/package/pdf-merger-js) that stitched all the docs into a single 730-page PDF. Then, I fed the PDF into [NotebookLM](https://notebooklm.google), Google’s AI-powered research assistant.
...
This technique isn’t just about speeding up prototyping, it’s about unlocking a bring-your-own-design-system future where _anyone_ within a company can test design ideas and output production-ready code that’s accessible, performant, and _on-brand_.
