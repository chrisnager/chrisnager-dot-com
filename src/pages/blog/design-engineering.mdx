...
export const Head = () => (
  <Halo
    description="This post is my perspective on, and appreciation for, design engineering."
    title="Design engineering / Blog"
    url="https://chrisnager.com/blog/design-engineering"
  />
)
