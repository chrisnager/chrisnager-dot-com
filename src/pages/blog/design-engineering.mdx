...
export const Head = () => <Halo description="This post is Chris Nager's perspective on, and appreciation for, design engineering." title="Design engineering / Blog" url="https://chrisnager.com/blog/design-engineering" />
...
![Venn diagram depicting overlapping "Design" and "Engineering" circles](/images/blog/design-engineering/design-engineering-venn-diagram.png)
